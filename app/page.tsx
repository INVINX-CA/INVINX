    ...
    <div className="min-h-screen bg-[#090909] text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#090909]/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
          <a
            href="#home"
            className="text-xl font-semibold tracking-[0.3em] text-[#c8a45a]"
          >
            INVINX
          </a>
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-2 lg:px-8 lg:py-32">
            <div className="relative z-10">
              ...
              <h1 className="max-w-2xl text-5xl font-semibold leading-tight md:text-6xl">
                Luxury finish.{" "}
                <span className="text-[#c8a45a]">Professional protection.</span>
              </h1>

              <p className="mt-6 max-w-xl text-lg leading-8 text-white/70">
                INVINX Paint Protection Film is engineered for dealerships,
                installers, and drivers who demand premium clarity, self-healing
        ...
        <section id="products" className="border-b border-white/10">
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
            <div className="max-w-3xl">
              <p className="text-sm uppercase tracking-[0.25em] text-[#c8a45a]">
                Products
              </p>
              ...
              <p className="mt-6 text-lg leading-8 text-white/70">
                INVINX offers a focused lineup of luxury paint protection films
                designed to deliver visual clarity, long-term durability, and
                consistent installation performance.
              </p>
            </div>
            ...
            <div className="grid gap-14 lg:grid-cols-[1.15fr_1fr]">
              <div>
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70">
                  INVINX films combine protective performance with a luxury
                  visual standard through layered construction built for clarity,
                  durability, and everyday drivability.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr]">
              <div>
                ...
                <p className="mt-6 max-w-xl text-lg leading-8 text-white/70">
                  Partner with INVINX to offer a premium paint protection
                  solution backed by responsive support, Canada-wide supply, and
                  installer-informed product performance.
                </p>
              ...
              <div className="rounded-[2rem] border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-8">
                ...
                <p className="mt-3 text-white/65">
                  Submit your business information and our team will follow up
                  with product and dealer details.
                </p>
                ...
                >
                  <div>
                    ...
                    <input
                      name="business_name"
                      type="text"
                      placeholder="Your dealership or shop"
                      required
        ...
        >
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-white/70">
                Resources for installers, dealerships, and vehicle owners to help
                maintain product appearance and get the most out of every
                installation.
              </p>
            </div>
            ...
            <div className="mt-14 grid gap-8 lg:grid-cols-3">
              <div className="rounded-[1.75rem] border border-white/10 bg-white/[0.03] p-8">
                ...
                <p className="mt-4 leading-8 text-white/65">
                  Hand washing is recommended. Avoid abrasive cleaners and
                  aggressive polishing compounds to preserve finish and clarity.
                </p>
              </div>
              ...
              <div className="rounded-[1.75rem] border border-white/10 bg-white/[0.03] p-8">
                ...
                <p className="mt-4 leading-8 text-white/65">
                  For product guidance, installation questions, or dealer
                  support, contact the INVINX team directly.
                </p>
                <a
                  href="#contact"
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-[1fr_1.05fr]">
              <div>
                ...
                <p className="mt-6 max-w-xl text-lg leading-8 text-white/70">
                  For product inquiries, sample requests, dealer opportunities,
                  or general support, send us a message and our team will get
                  back to you.
                </p>
                ...
                <div className="mt-10 rounded-[1.75rem] border border-white/10 bg-white/[0.03] p-8 text-white/75">
                  ...
                  <p className="mt-3 text-lg">
                    Canada-wide availability for dealerships, installers, and
                    retail consumers.
                  </p>
                </div>
              </div>
      ...
      <footer className="border-t border-white/10 bg-black/30">
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-10 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            <div className="text-lg font-semibold tracking-[0.3em] text-[#c8a45a]">
              INVINX
            </div>
